...
const staticCopy = {
  en: {
    ...
    homeHeroTitle: "Build Mexican Spanish grammar that actually sticks.",
    homeHeroText: "Deep lessons for pronouns, tenses, connectors, adjectives, time expressions, and the patterns that make everyday Spanish feel natural.",
    lessonTopics: "lesson topics",
    mastery: "mastery",
    lessonsCard: "Lessons page",
    lessonsCardText: "Move through the core grammar map: pronouns, connectors, adjectives, time expressions, and the top Spanish tenses.",
...
const localizedUiOverrides = {
  hi: {
    ...
    homeHeroTitle: "मैक्सिकन स्पैनिश व्याकरण को सच में समझें।",
    homeHeroText: "सर्वनाम, काल, संयोजक, विशेषण, समय के प्रयोग और रोज़मर्रा की स्पैनिश को स्वाभाविक बनाने वाले पैटर्न के लिए गहरे पाठ।",
    lessonTopics: "पाठ विषय",
    mastery: "निपुणता",
    lessonsCard: "पाठ पृष्ठ",
    lessonsCardText: "मुख्य व्याकरण मानचित्र पर आगे बढ़ें: सर्वनाम, संयोजक, विशेषण, समय के प्रयोग और स्पैनिश के मुख्य काल।",
  ...
  ta: {
    ...
    homeHeroTitle: "மெக்சிகன் ஸ்பானிஷ் இலக்கணத்தை உண்மையாகப் புரிந்துகொள்ளுங்கள்.",
    homeHeroText: "சுட்டுப்பெயர்கள், காலங்கள், இணைப்புச் சொற்கள், பெயரெச்சங்கள், நேரப் பயன்பாடுகள், மற்றும் இயல்பான தினசரி ஸ்பானிஷ் உருவாக்கும் அமைப்புகளுக்கான ஆழமான பாடங்கள்.",
    lessonTopics: "பாடத் தலைப்புகள்",
    mastery: "திறன் நிலை",
    lessonsCardText: "முக்கிய இலக்கண வரைபடத்தில் நகருங்கள்: சுட்டுப்பெயர்கள், இணைப்புச் சொற்கள், பெயரெச்சங்கள், நேரப் பயன்பாடுகள், மற்றும் ஸ்பானிஷ் முக்கிய காலங்கள்.",
  ...
  bn: {
    ...
    homeHeroTitle: "মেক্সিকান স্প্যানিশ ব্যাকরণ সত্যি করে বুঝুন।",
    homeHeroText: "সর্বনাম, কাল, সংযোগকারী, বিশেষণ, সময়ের ব্যবহার এবং দৈনন্দিন স্প্যানিশকে স্বাভাবিক করে তোলা প্যাটার্নের জন্য গভীর পাঠ।",
    lessonTopics: "পাঠের বিষয়",
    mastery: "দক্ষতা",
    lessonsCard: "পাঠ পৃষ্ঠা",
    lessonsCardText: "মূল ব্যাকরণ মানচিত্র ধরে এগোন: সর্বনাম, সংযোগকারী, বিশেষণ, সময়ের ব্যবহার এবং স্প্যানিশের প্রধান কাল।",
  ...
  am: {
    ...
    homeHeroTitle: "የሜክሲኮ ስፓኒሽ ሰዋሰውን በጥልቅ ይረዱ።",
    homeHeroText: "ለተውላጠ ስሞች፣ ለግስ ጊዜዎች፣ ለማገናኛ ቃላት፣ ለቅጽሎች፣ ለጊዜ አገላለጾች እና ዕለታዊ ስፓኒሽን ተፈጥሯዊ ለሚያደርጉ አቀራረቦች ጥልቅ ትምህርቶች።",
    lessonTopics: "የትምህርት ርዕሶች",
    mastery: "ችሎታ",
    lessonsCard: "የትምህርት ገጽ",
    lessonsCardText: "በዋናው የሰዋሰው ካርታ ይጓዙ፦ ተውላጠ ስሞች፣ ማገናኛ ቃላት፣ ቅጽሎች፣ የጊዜ አገላለጾች እና ዋና የስፓኒሽ የግስ ጊዜዎች።",
    examsCard: "የፈተና ገጽ",
