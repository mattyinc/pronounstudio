...
const staticCopy = {
  en: {
    ...
    homeHeroTitle: "Learn Mexican Spanish grammar clearly.",
    homeHeroText: "Deep lessons for pronouns, tenses, connectors, adjectives, time expressions, and everyday Spanish patterns.",
